...
const TimelineTransition = ({ id, type, startTime, endTime, duration, clipAId, clipBId, clipAThumbnail, clipBThumbnail, direction, onDurationChange }) => {
    ...
    const handleDragEnd = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((e) => {
        if (!e.clientX)
            return;
        const newDuration = Math.max(0.5, Math.min(5.0, duration + (e.clientX - e.currentTarget.getBoundingClientRect().left) / 100));
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("9134d61b1b9bef4f12b8")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.b6c13f8f065c57b4449d.hot-update.js.map