...
const TimelineTransition = ({ id, type, startTime, endTime, duration, clipAId, clipBId, clipAThumbnail, clipBThumbnail, direction, onDurationChange }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: `timeline-transition ${typeof type === 'string' ? type : _types_transition__WEBPACK_IMPORTED_MODULE_2__.TransitionType[type]}`, "data-testid": "timeline-transition", "data-transition-id": id, "data-type": typeof type === 'string' ? type : _types_transition__WEBPACK_IMPORTED_MODULE_2__.TransitionType[type], "data-duration": Number(duration), "data-direction": direction, style: {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("2f75313aea73cd52b107")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.9e40adf367f1091b7a5b.hot-update.js.map