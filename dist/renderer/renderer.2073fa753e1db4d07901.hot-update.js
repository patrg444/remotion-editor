...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.timeline-tracks-container {
  position: relative;
  overflow: visible;
}
...
`, "",{"version":3,"sources":["webpack://./src/renderer/styles/timeline.css"],"names":[],"mappings":"AAAA;EACE,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;EACE,iBAAiB;EACjB,kBAAkB;EAClB,iBAAiB;EACjB;;;;;;GAMC;AACH;;AAEA;EACE,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,kBAAkB;EAClB,WAAW;EACX,YAAY;AACd;;AAEA;EACE,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,gCAAgC;EAChC,kBAAkB;EAClB,+BAA+B;EAC/B,eAAe;EACf,aAAa;EACb,kBAAkB;EAClB,iCAAiC;AACnC;;AAEA;EACE,qCAAqC;AACvC;;AAEA;EACE,eAAe;EACf,kBAAkB;AACpB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,YAAY;EACZ,MAAM;EACN,8BAA8B;EAC9B,0CAA0C;EAC1C,kBAAkB;EAClB,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,mBAAmB;EACnB,UAAU;EACV,0BAA0B;AAC5B;;AAEA;EACE,kBAAkB;EAClB,UAAU;EACV,YAAY;EACZ,oCAAoC;EACpC,iBAAiB;EACjB,UAAU;AACZ;;AAEA;EACE,OAAO;EACP,2BAA2B;EAC3B,8BAA8B;AAChC;;AAEA;EACE,QAAQ;EACR,4BAA4B;EAC5B,+BAA+B;AACjC;;AAEA;EACE,eAAe;EACf,+BAA+B;EAC/B,oBAAoB;AACtB;;AAEA;EACE,kBAAkB;EAClB,MAAM;EACN,OAAO;EACP,WAAW;EACX,YAAY;EACZ,gBAAgB;EAChB,oBAAoB;AACtB;;AAEA;EACE,kBAAkB;EAClB,MAAM;EACN,OAAO;EACP,WAAW;EACX,YAAY;EACZ,oBAAoB;EACpB,8BAA8B;AAChC","sourcesContent":[".timeline-tracks-container {\n  position: relative;\n  overflow: visible;\n}\n\n.timeline-tracks-content {\n  min-height: 200px;\n  position: relative;\n  overflow: visible;\n  background: repeating-linear-gradient(\n    45deg,\n    rgba(255, 255, 255, 0.02) 0px,\n    rgba(255, 255, 255, 0.02) 10px,\n    transparent 10px,\n    transparent 20px\n  );\n}\n\n.timeline-tracks-controls {\n  position: relative;\n  overflow: visible;\n}\n\n.timeline-track {\n  min-height: 60px;\n  overflow: visible;\n  position: relative;\n}\n\n.track-content {\n  min-height: 60px;\n  overflow: visible;\n  position: relative;\n  width: 100%;\n  height: 100%;\n}\n\n.timeline-tracks-empty {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  text-align: center;\n  color: rgba(255, 255, 255, 0.5);\n  cursor: pointer;\n  padding: 20px;\n  border-radius: 8px;\n  transition: background-color 0.2s;\n}\n\n.timeline-tracks-empty:hover {\n  background: rgba(255, 255, 255, 0.05);\n}\n\n.timeline-tracks-empty-icon {\n  font-size: 24px;\n  margin-bottom: 8px;\n}\n\n.timeline-tracks-empty span {\n  font-size: 14px;\n}\n\n.timeline-transition {\n  position: absolute;\n  height: 20px;\n  top: 0;\n  background: rgba(0, 0, 0, 0.2);\n  border: 1px solid rgba(255, 255, 255, 0.3);\n  border-radius: 4px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  pointer-events: all;\n  z-index: 2;\n  transform: translateY(50%);\n}\n\n.timeline-transition-handle {\n  position: absolute;\n  width: 8px;\n  height: 100%;\n  background: rgba(255, 255, 255, 0.3);\n  cursor: ew-resize;\n  z-index: 3;\n}\n\n.timeline-transition-handle.left {\n  left: 0;\n  border-top-left-radius: 4px;\n  border-bottom-left-radius: 4px;\n}\n\n.timeline-transition-handle.right {\n  right: 0;\n  border-top-right-radius: 4px;\n  border-bottom-right-radius: 4px;\n}\n\n.timeline-transition-icon {\n  font-size: 14px;\n  color: rgba(255, 255, 255, 0.8);\n  pointer-events: none;\n}\n\n.timeline-transition-preview {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  overflow: hidden;\n  pointer-events: none;\n}\n\n.timeline-transition canvas {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  pointer-events: none;\n  background: rgba(0, 0, 0, 0.1);\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3f86014f8900c2331870")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.2073fa753e1db4d07901.hot-update.js.map