        ...
        default: {
            ...
            if (isUndoable(action)) {
                ...
                const finalState = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(stateCopy, draft => {
                    ...
                    // Create deep copies of patches to avoid any proxy issues
                    const patchesCopy = patches.map(patch => ({ ...patch }));
                    const inversePatchesCopy = inversePatches.map(patch => ({ ...patch }));
                    const entry = {
                        type: 'partial',
                        timestamp: Date.now(),
                        patches: patchesCopy,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ea2718aa075bf64ccd6c")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.65707d3d86ecfb5a7c14.hot-update.js.map