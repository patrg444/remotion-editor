            ...
            case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.SPLIT_CLIP:
                {
                    ...
                    if (trackToSplit) {
                        ...
                        if (clipToSplit && action.payload.time > clipToSplit.startTime && action.payload.time < clipToSplit.endTime) {
                            ...
                            // Create first clip with updated reference bounds relative to its segment
                            const firstClip = {
                                ...clipToSplit,
                                id: `${clipToSplit.id}-1`,
                                endTime: splitPoint,
                                ...
                                // Set reference bounds for first segment relative to original media
                                initialBounds: {
                                    startTime: clipToSplit.startTime,
                                    endTime: splitPoint,
                                    mediaOffset: firstMediaStart,
                                    mediaDuration: originalMediaDuration - firstMediaStart // Adjust media duration based on offset
                                }
                            };
                            // Create second clip with updated reference bounds relative to its segment
                            const secondClip = {
                                ...clipToSplit,
                                id: `${clipToSplit.id}-2`,
                                ...
                                // Set reference bounds for second segment relative to original media
                                initialBounds: {
                                    startTime: splitPoint,
                                    endTime: clipToSplit.endTime,
                                    mediaOffset: secondMediaStart,
                                    mediaDuration: originalMediaDuration // Keep full media duration for extension reference
                                }
                            };
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("eaefd1be7eef28817c1c")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.d72e5ea51ee65e28a97c.hot-update.js.map