...
const TimelineTransition = ({ id, type, startTime, endTime, duration, clipAId, clipBId, clipAThumbnail, clipBThumbnail, direction, params, onDurationChange }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: `timeline-transition ${type}`, "data-testid": "timeline-transition", "data-transition-id": id, "data-type": type, "data-duration": duration.toString(), "data-direction": direction || 'right', "data-params": JSON.stringify({
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("bab6a8704f74478a719d")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.80d1fd4b8c4d57fbea99.hot-update.js.map