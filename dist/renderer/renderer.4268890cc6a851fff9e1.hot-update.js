                    ...
                    case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.ADD_TRANSITION: {
                        ...
                        if (trackIndex !== -1) {
                            ...
                            if (clipA && clipB) {
                                ...
                                if (areAdjacent) {
                                    // Initialize transitions array and transition properties if they don't exist
                                    const updatedTrack = {
                                        ...track,
                                    ...
                                    // Add transition to the initialized array
                                    const newTransition = {
                                        ...transition,
                                        duration,
                                        id: transition.id,
                                    ...
                                    // Ensure transitions array exists and is an array
                                    if (!Array.isArray(updatedTrack.transitions)) {
                                        updatedTrack.transitions = [];
                                    }
                                    // Add transition
                                    updatedTrack.transitions.push(newTransition);
                                    // Update the track in draft
                                    draft.tracks[trackIndex] = updatedTrack;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("27588fb4096f9605b1af")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.4268890cc6a851fff9e1.hot-update.js.map