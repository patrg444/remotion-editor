...
const TimelineTransition = ({ id, type, startTime, endTime, duration, clipAId, clipBId, clipAThumbnail, clipBThumbnail, direction, onDurationChange }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: `timeline-transition ${type}`, "data-testid": "timeline-transition", "data-transition-id": id, "data-type": typeof type === 'string' ? type : _types_transition__WEBPACK_IMPORTED_MODULE_2__.TransitionType[type], "data-duration": Number(duration), "data-direction": direction, style: {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("9e40adf367f1091b7a5b")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.65453d5f597aa2adc8be.hot-update.js.map