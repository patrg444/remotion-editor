    ...
    switch (action.type) {
        ...
        default: {
            ...
            if (isUndoable(action)) {
                ...
                const finalState = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(stateCopy, draft => {
                    // Create a fresh copy of the next state and apply it
                    const nextStateCopy = JSON.parse(JSON.stringify(nextState));
                    Object.assign(draft, nextStateCopy);
                    ...
                    if (!selectedClipsExist && nextStateCopy.tracks.length > 0) {
                        ...
                        draft.selectedClipIds = Array.from(prevSelectedClipIds);
                    }
                    // Update history
                    // Create deep copies of patches to avoid any proxy issues
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("54f2aa4736ec2a083beb")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.cdc01701cef8188a3a95.hot-update.js.map