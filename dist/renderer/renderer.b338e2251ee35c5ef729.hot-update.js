...
const createStateDiff = (before, after, description, isCheckpoint = false) => {
    ...
    if (before.rippleState !== after.rippleState)
        changes.rippleState = JSON.parse(JSON.stringify(after.rippleState));
...
const applyStateDiff = (state, diff, reverse = false) => {
    ...
    if (reverse) {
        ...
        if (diff.changes.rippleState !== undefined)
            newState.rippleState = JSON.parse(JSON.stringify(state.rippleState));
        ...
        if (diff.changes.rippleState !== undefined)
            newState.rippleState = JSON.parse(JSON.stringify(diff.changes.rippleState));
        if (diff.changes.selectedClipIds !== undefined)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d0c9bc66ae452f964106")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.b338e2251ee35c5ef729.hot-update.js.map