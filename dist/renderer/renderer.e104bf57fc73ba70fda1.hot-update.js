...
const TimelineTransition = ({ id, type, startTime, endTime, duration, clipAId, clipBId, clipAThumbnail, clipBThumbnail, onDurationChange }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: `timeline-transition ${type}`, "data-testid": "timeline-transition", "data-transition-id": id, "data-type": type, "data-duration": Number(duration), style: {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("afff9920f8d15c298739")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.e104bf57fc73ba70fda1.hot-update.js.map