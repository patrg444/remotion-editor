        ...
        default: {
            ...
            if (isUndoable(action)) {
                ...
                const finalState = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(stateCopy, draft => {
                    ...
                    // Update state properties one by one to maintain references
                    draft.tracks = JSON.parse(JSON.stringify(nextStateCopy.tracks));
                    draft.selectedClipIds = Array.from(nextStateCopy.selectedClipIds || []);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("70b63569d0a498c138ff")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.30e3f3e1c8904a4dd560.hot-update.js.map