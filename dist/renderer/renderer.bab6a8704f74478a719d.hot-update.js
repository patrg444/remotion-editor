...
const TimelineTransition = ({ id, type, startTime, endTime, duration, clipAId, clipBId, clipAThumbnail, clipBThumbnail, direction, params, onDurationChange }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: `timeline-transition ${type}`, "data-testid": "timeline-transition", "data-transition-id": id, "data-type": type, "data-duration": params?.duration?.toString() || duration.toString(), "data-direction": direction || 'right', "data-params": JSON.stringify({
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("288155d75fefc116f32a")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.bab6a8704f74478a719d.hot-update.js.map