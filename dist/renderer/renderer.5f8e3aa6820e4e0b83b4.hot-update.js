...
const TimelineClip = ({ clip, track, layer, zoom, fps, onSelect, onDragStart, onDragEnd, tabIndex = 0, 'aria-posinset': posinset, 'aria-setsize': setsize, style }) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        if (clipRef.current) {
            ...
            _utils_logger__WEBPACK_IMPORTED_MODULE_12__.logger.debug('Clip rendered:', {
                clipId: clip.id,
                rect,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("a1dc22dca3a752ea2690")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.5f8e3aa6820e4e0b83b4.hot-update.js.map