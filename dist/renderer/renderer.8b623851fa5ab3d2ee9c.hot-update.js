...
const TimelineTransition = react__WEBPACK_IMPORTED_MODULE_0___default().memo(({ id, type, startTime, endTime, duration, clipAId, clipBId, clipAThumbnail, clipBThumbnail, direction, params, onDurationChange }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: `timeline-transition ${type}`, "data-testid": "timeline-transition", "data-transition-id": id, "data-type": type, "data-duration": params?.duration?.toString() || duration.toString(), "data-direction": direction || params?.direction || 'right', "data-params": JSON.stringify({
            ...params,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("658098abdffa83877e2f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.8b623851fa5ab3d2ee9c.hot-update.js.map