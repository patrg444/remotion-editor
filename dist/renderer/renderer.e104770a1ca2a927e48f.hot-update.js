            ...
            case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.SPLIT_CLIP:
                {
                    ...
                    if (trackToSplit) {
                        ...
                        if (clipToSplit && action.payload.time > clipToSplit.startTime && action.payload.time < clipToSplit.endTime) {
                            ...
                            // Create first clip with its own reference bounds
                            const firstClip = {
                                ...clipToSplit,
                                id: `${clipToSplit.id}-1`,
                                endTime: splitPoint,
                            ...
                            // Create second clip with its own reference bounds
                            const secondClip = {
                                ...clipToSplit,
                                id: `${clipToSplit.id}-2`,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6983e730dffc5075b43e")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.e104770a1ca2a927e48f.hot-update.js.map