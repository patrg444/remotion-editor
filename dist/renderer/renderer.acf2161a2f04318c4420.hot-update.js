                        ...
                        if (trackToSplit) {
                            ...
                            if (clipToSplit && action.payload.time > clipToSplit.startTime && action.payload.time < clipToSplit.endTime) {
                                ...
                                const firstClip = {
                                    ...
                                    content: {
                                        ...clipToSplit.content,
                                        frames: clipToSplit.content?.frames?.slice(0, Math.floor(splitPoint * clipToSplit.fps)) || []
                                    }
                                };
                                // Create second clip
                                const secondClip = {
                                    ...
                                    content: {
                                        ...clipToSplit.content,
                                        frames: clipToSplit.content?.frames?.slice(Math.floor(splitPoint * clipToSplit.fps)) || []
                                    }
                                };
                                // Log split operation
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1e4425232c6ab0f01cdb")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.acf2161a2f04318c4420.hot-update.js.map