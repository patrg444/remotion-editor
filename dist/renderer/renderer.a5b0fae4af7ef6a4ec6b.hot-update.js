...
/* harmony import */ var _hooks_useTimelineContext__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../hooks/useTimelineContext */ "./src/renderer/hooks/useTimelineContext.ts");
/* harmony import */ var _TimelineClip__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./TimelineClip */ "./src/renderer/components/TimelineClip.tsx");
/* harmony import */ var _TimelineTransition__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./TimelineTransition */ "./src/renderer/components/TimelineTransition.tsx");
/* harmony import */ var _hooks_useLayerManagement__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../hooks/useLayerManagement */ "./src/renderer/hooks/useLayerManagement.ts");
/* harmony import */ var _utils_logger__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/logger */ "./src/renderer/utils/logger.ts");
/* harmony import */ var _utils_timelineConstants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/timelineConstants */ "./src/renderer/utils/timelineConstants.ts");
...
const TimelineTrack = ({ track, isSelected, zoom, fps, onSelectTrack, onSelectClip, onClipDragStart, onClipDragEnd, onToggleVisibility, onUpdateTrack, onDeleteTrack, onMoveTrack }) => {
    ...
    const { assignLayers, getTrackHeight, getClipTop } = (0,_hooks_useLayerManagement__WEBPACK_IMPORTED_MODULE_6__.useLayerManagement)();
    const { state, dispatch } = (0,_hooks_useTimelineContext__WEBPACK_IMPORTED_MODULE_3__.useTimelineContext)();
        ...
        if (containerRef.current && trackContentRef.current) {
            ...
            requestAnimationFrame(() => {
                if (containerRef.current && trackContentRef.current) {
                    ...
                    _utils_logger__WEBPACK_IMPORTED_MODULE_7__.logger.debug('[TimelineTrack] Track positioned:', {
                        trackId: track.id,
                        containerRect,
                        contentRect,
                        clipCount: track.clips.length
    ...
    const handleDragEnter = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((e) => {
        e.preventDefault();
        e.stopPropagation();
        _utils_logger__WEBPACK_IMPORTED_MODULE_7__.logger.debug('Track drag enter:', {
            target: e.target,
    ...
    const handleDragOver = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((e) => {
        e.preventDefault();
        e.stopPropagation();
        _utils_logger__WEBPACK_IMPORTED_MODULE_7__.logger.debug('Track drag over:', {
            target: e.target,
            currentTarget: e.currentTarget,
            className: e.currentTarget.className
        });
    ...
    const handleDragLeave = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((e) => {
        e.preventDefault();
        e.stopPropagation();
        _utils_logger__WEBPACK_IMPORTED_MODULE_7__.logger.debug('Track drag leave:', {
            target: e.target,
            currentTarget: e.currentTarget,
            className: e.currentTarget.className
        });
    ...
    const handleDrop = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((e) => {
        ...
        e.currentTarget.classList.remove('drag-over');
        try {
            _utils_logger__WEBPACK_IMPORTED_MODULE_7__.logger.debug('Drop event:', {
            ...
            if (!jsonData) {
                _utils_logger__WEBPACK_IMPORTED_MODULE_7__.logger.error('No JSON data in drop event');
                return;
            }
            const data = JSON.parse(jsonData);
            _utils_logger__WEBPACK_IMPORTED_MODULE_7__.logger.debug('Parsed drop data:', data);
            if (data) {
                // Calculate time position based on drop coordinates
                const trackRect = e.currentTarget.getBoundingClientRect();
                const dropX = e.clientX - trackRect.left;
                const timeScale = _utils_timelineConstants__WEBPACK_IMPORTED_MODULE_8__.TimelineConstants.Scale.getScale(state.zoom);
    ...
    const trackHeight = Math.max(_utils_timelineConstants__WEBPACK_IMPORTED_MODULE_8__.TimelineConstants.UI.TRACK_HEIGHT, getTrackHeight(layeredClips));
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { ref: trackContentRef, "data-testid": "track-content", className: "track-content", role: "list", "aria-label": `Clips in ${track.name}`, onDragEnter: handleDragEnter, onDragOver: handleDragOver, onDragLeave: handleDragLeave, onDrop: handleDrop, onMouseDown: (e) => {
            ...
            track.transitions?.map((transition) => {
                ...
                console.log('Transition type:', {
                    rawType: transition.type,
                    enumType: _types_transition__WEBPACK_IMPORTED_MODULE_2__.TransitionType[transition.type]
                });
                const transitionType = _types_transition__WEBPACK_IMPORTED_MODULE_2__.TransitionType[transition.type];
                if (!transitionType) {
                    console.error('Invalid transition type:', transition.type);
                    return null;
                }
                return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_TimelineTransition__WEBPACK_IMPORTED_MODULE_5__.TimelineTransition, { key: transition.id, id: transition.id, type: transitionType, startTime: clipA.endTime - transition.duration, endTime: clipB.startTime + transition.duration, duration: transition.duration, clipAId: clipA.id, clipBId: clipB.id, clipAThumbnail: (0,_types_timeline__WEBPACK_IMPORTED_MODULE_1__.isVideoClip)(clipA) ? clipA.thumbnail : undefined, clipBThumbnail: (0,_types_timeline__WEBPACK_IMPORTED_MODULE_1__.isVideoClip)(clipB) ? clipB.thumbnail : undefined, direction: transition.params?.direction, onDurationChange: (newDuration) => {
                        dispatch({
            ...
            layeredClips.map((clip, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_TimelineClip__WEBPACK_IMPORTED_MODULE_4__.TimelineClip, { key: clip.id, clip: clip, track: track, layer: clip.layer, zoom: state.zoom, fps: state.fps, onSelect: () => onSelectClip(clip.id), onDragStart: () => onClipDragStart(clip.id), onDragEnd: onClipDragEnd, tabIndex: isSelected ? 0 : -1, "aria-posinset": index + 1, "aria-setsize": layeredClips.length, style: {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("cb4dc3c78d1327d8c7bd")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.a5b0fae4af7ef6a4ec6b.hot-update.js.map