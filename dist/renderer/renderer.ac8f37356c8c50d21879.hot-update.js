    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        const handleClipRendered = (e) => {
            if (e.detail.clipId === clip.id && clipRef.current) {
                ...
                clipRef.current.style.top = `${e.detail.layer * _utils_timelineConstants__WEBPACK_IMPORTED_MODULE_7__.TimelineConstants.TRACK_HEIGHT}px`;
                _utils_logger__WEBPACK_IMPORTED_MODULE_12__.logger.debug('Updated clip style:', {
                    clipId: clip.id,
                    left,
                    width,
                    top: e.detail.layer * _utils_timelineConstants__WEBPACK_IMPORTED_MODULE_7__.TimelineConstants.TRACK_HEIGHT,
                    zoom
                });
            }
        };
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ed047abc017927e3c29d")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.ac8f37356c8c50d21879.hot-update.js.map