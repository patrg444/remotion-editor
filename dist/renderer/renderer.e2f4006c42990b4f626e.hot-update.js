...
const Timeline = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(({ containerWidth, scrollLeft, onScroll, onTimeUpdate }) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        const timelineElement = document.querySelector('[data-testid="timeline"]');
        if (!timelineElement)
            return;
        // Focus timeline element to ensure it can receive keyboard events
        timelineElement.focus();
        const handleKeyDown = (e) => {
            const keyboardEvent = e;
            // Handle undo/redo shortcuts regardless of selection state
            if (keyboardEvent.key === 'z' && (keyboardEvent.metaKey || keyboardEvent.ctrlKey)) {
        ...
        return () => timelineElement.removeEventListener('keydown', handleKeyDown);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3fe6b7320517e7edac49")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.e2f4006c42990b4f626e.hot-update.js.map