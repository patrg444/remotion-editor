    ...
    switch (action.type) {
        ...
        case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.UNDO: {
            if (state.history.currentIndex > 0) {
                ...
                const inversePatchesCopy = entry.inversePatches.map(patch => ({ ...patch }));
                // Apply patches to the copy
                const undone = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(stateCopy, draft => {
                    (0,immer__WEBPACK_IMPORTED_MODULE_5__.applyPatches)(draft, inversePatchesCopy);
                });
                // Create final state with updated history
                const finalState = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(undone, draft => {
                    draft.history = {
        ...
        case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.REDO: {
            if (state.history.currentIndex < state.history.entries.length - 1) {
                ...
                const stateCopy = JSON.parse(JSON.stringify(state));
                // Create deep copies of patches to avoid any proxy issues
                const patchesCopy = entry.patches.map(patch => ({ ...patch }));
                // Apply patches to the copy
                const redone = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(stateCopy, draft => {
                    (0,immer__WEBPACK_IMPORTED_MODULE_5__.applyPatches)(draft, patchesCopy);
                });
                // Create final state with updated history
                const finalState = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(redone, draft => {
                    draft.history = {
                        entries: state.history.entries,
                        currentIndex: newIndex
                    };
        ...
        default: {
            ...
            if (isUndoable(action)) {
                // Create a fresh copy of state before applying patches
                const stateCopy = JSON.parse(JSON.stringify(state));
                // Apply the action changes first
                const stateWithChanges = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(stateCopy, draft => {
                    Object.assign(draft, nextState);
                });
                // Then update history in a separate produce call
                const finalState = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(stateWithChanges, draft => {
                    // Create deep copies of patches to avoid any proxy issues
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ed5b8bb79f1f42cca4a6")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.651cf08df34c20cfcf96.hot-update.js.map