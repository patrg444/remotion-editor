...
const TimelineProvider = ({ children }) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        ...
        try {
            ...
            // Step 3: Set up state in next frame
            requestAnimationFrame(() => {
                // Set state and dispatch ready event
                window.timelineState = { ...state, dispatch };
                window.dispatchEvent(new CustomEvent('timeline:dispatchReady'));
                // Wait for next frame to ensure state is ready
                requestAnimationFrame(() => {
                    // Set ready flag and dispatch initialized event
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b3006080acfbf05eb32f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.0a0aa1429cebd37b8769.hot-update.js.map