        ...
        default: {
            ...
            if (isUndoable(action)) {
                ...
                const finalState = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(stateCopy, draft => {
                    ...
                    const prevSelectedClipIds = Array.from(currentState.selectedClipIds || []);
                    // Update state properties one by one to maintain references
                    Object.keys(nextStateCopy).forEach(key => {
                        if (key !== 'history') {
                            draft[key] = nextStateCopy[key];
                        }
                    });
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("0ef00aab35533ae9e104")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.54f2aa4736ec2a083beb.hot-update.js.map