...
const TimelineClip = ({ clip, track, layer, zoom, fps, onSelect, onDragStart, onDragEnd, tabIndex = 0, 'aria-posinset': posinset, 'aria-setsize': setsize, style }) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        ...
        if (clipRef.current) {
            ...
            // Use Promise.resolve().then to ensure this runs after React updates
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("2dc8739f9c8f4ef8c8ad")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.f0ec52fcb0b85025fe15.hot-update.js.map