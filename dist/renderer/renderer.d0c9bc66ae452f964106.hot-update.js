...
const HISTORY_ACTIONS = new Set([
    'TRIM_CLIP',
    'SPLIT_CLIP',
    'ADD_CLIP' // Add clip should be a history action, not a checkpoint
]);
            ...
            case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.SPLIT_CLIP:
                {
                    ...
                    if (trackToSplit) {
                        ...
                        if (clipToSplit && action.payload.time > clipToSplit.startTime && action.payload.time < clipToSplit.endTime) {
                            ...
                            // Log final state and update selection
                            ...
                            // Update selection after all other changes
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b06e7d99a409ab19322e")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.d0c9bc66ae452f964106.hot-update.js.map