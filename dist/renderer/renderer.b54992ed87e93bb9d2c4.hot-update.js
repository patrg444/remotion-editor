    ...
    switch (action.type) {
        ...
        case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.UNDO: {
            if (state.history.currentIndex > 0) {
                ...
                const undone = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(state, draft => {
                    (0,immer__WEBPACK_IMPORTED_MODULE_5__.applyPatches)(draft, inversePatches);
                });
                const finalState = {
                    ...undone,
                    history: {
        ...
        case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.REDO: {
            if (state.history.currentIndex < state.history.entries.length - 1) {
                ...
                const redone = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(state, draft => {
                    (0,immer__WEBPACK_IMPORTED_MODULE_5__.applyPatches)(draft, patches);
                });
                const finalState = {
                    ...redone,
                    history: {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b46896fbe93051c7f727")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.b54992ed87e93bb9d2c4.hot-update.js.map