    ...
    switch (action.type) {
        ...
        case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.UNDO: {
            if (state.history.currentIndex > 0) {
                ...
                const stateCopy = JSON.parse(JSON.stringify({
                    ...
                    tracks: state.tracks.map(track => ({
                        ...
                        clips: track.clips.map(clip => ({
                            ...
                            mediaDuration: clip.mediaDuration || (clip.endTime - clip.startTime)
                        }))
                    }))
                }));
                ...
                // Preserve original history and ensure clip references are maintained
                const finalState = {
                    ...undone,
                    history: {
                ...
                // Dispatch clip:rendered event for each clip
                setTimeout(() => {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("db4cc1ff8f608c28a364")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.fa7062a51ff3442040e3.hot-update.js.map