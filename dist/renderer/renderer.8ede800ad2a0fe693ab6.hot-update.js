        ...
        if (containerRef.current && trackContentRef.current) {
            ...
            requestAnimationFrame(() => {
                if (containerRef.current && trackContentRef.current) {
                    ...
                    _utils_logger__WEBPACK_IMPORTED_MODULE_5__.logger.debug('[TimelineTrack] Track positioned:', {
                        trackId: track.id,
                        containerRect,
                        contentRect,
                        clipCount: track.clips.length
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("083615d4f755c9ff310f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.8ede800ad2a0fe693ab6.hot-update.js.map