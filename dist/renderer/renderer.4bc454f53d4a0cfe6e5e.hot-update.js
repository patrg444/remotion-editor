                        ...
                        if (trackIndex !== -1) {
                            ...
                            if (clipA && clipB) {
                                ...
                                if (areAdjacent) {
                                    ...
                                    updatedTrack.transitions.push({
                                        ...transition,
                                        duration
                                    });
                                    console.log('Added transition:', {
                                        track: updatedTrack,
                                        transition: updatedTrack.transitions[updatedTrack.transitions.length - 1]
                                    });
                                }
                            }
                        }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d2ced48ff1a181357a8b")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.4bc454f53d4a0cfe6e5e.hot-update.js.map