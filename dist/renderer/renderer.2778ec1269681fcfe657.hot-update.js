                ...
                const finalState = (0,immer__WEBPACK_IMPORTED_MODULE_5__.produce)(stateCopy, draft => {
                    ...
                    if (!selectedClipsExist && draft.tracks.length > 0) {
                        ...
                        if (firstTrack.clips.length > 0) {
                            ...
                            // Force a patch for selection state by creating a new array reference
                            draft.selectedClipIds = Array.from(draft.selectedClipIds);
                        }
                    }
                    // Ensure the selection is properly tracked in the state
                    Object.defineProperty(draft, 'selectedClipIds', {
                        configurable: true,
                        enumerable: true,
                        value: draft.selectedClipIds,
                        writable: true
                    });
                    // Update history
                    draft.history = {
                    ...
                    case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.SPLIT_CLIP: {
                        ...
                        if (trackToSplit) {
                            ...
                            if (clipToSplit && action.payload.time > clipToSplit.startTime && action.payload.time < clipToSplit.endTime) {
                                ...
                                const newSelectedClipIds = [firstClip.id];
                                // Force a patch for selection state by creating a new array reference
                                draft.selectedClipIds = Array.from(newSelectedClipIds);
                                // Notify of selection change
                                requestAnimationFrame(() => {
                                    window.dispatchEvent(new CustomEvent('timeline:selection-change', {
                                        detail: {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("855d425b0d0f65a4a57c")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.2778ec1269681fcfe657.hot-update.js.map