...
const TimelineClip = ({ clip, track, layer, zoom, fps, onSelect, onDragStart, onDragEnd, tabIndex = 0, 'aria-posinset': posinset, 'aria-setsize': setsize, style }) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        ...
        if (!hasEmittedRef.current && clipRef.current) {
            ...
            requestAnimationFrame(() => {
                if (clipRef.current) {
                    ...
                    _utils_logger__WEBPACK_IMPORTED_MODULE_12__.logger.debug('[TimelineClip] Mounted/Updated:', {
                        clipId: clip.id,
                        rect,
                    ...
                    requestAnimationFrame(() => {
                        if (clipRef.current) {
                            ...
                            _utils_logger__WEBPACK_IMPORTED_MODULE_12__.logger.debug('[TimelineClip] Positioned:', {
                                clipId: clip.id,
                                rect: updatedRect,
                                style: clipRef.current.style
                            });
        ...
        return () => {
            ...
            if (propsChanged) {
                hasEmittedRef.current = false;
                _utils_logger__WEBPACK_IMPORTED_MODULE_12__.logger.debug('[TimelineClip] Reset emission flag:', {
                    clipId: clip.id,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("8b6fa213c664bdd5cded")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.23e43d1652160fa75a81.hot-update.js.map