...
/* harmony import */ var _types_transition__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../types/transition */ "./src/renderer/types/transition.ts");
    ...
    switch (action.type) {
        ...
        case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.UNDO: {
            if (state.history.currentIndex > 0) {
                ...
                const finalState = (0,immer__WEBPACK_IMPORTED_MODULE_4__.produce)(stateCopy, draft => {
                    ...
                    (0,immer__WEBPACK_IMPORTED_MODULE_4__.applyPatches)(draft, inversePatchesCopy);
        ...
        case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.REDO: {
            if (state.history.currentIndex < state.history.entries.length - 1) {
                ...
                const finalState = (0,immer__WEBPACK_IMPORTED_MODULE_4__.produce)(stateCopy, draft => {
                    ...
                    // Apply patches and ensure selection state is preserved
                    const prevSelectedClipIds = Array.from(draft.selectedClipIds);
                    (0,immer__WEBPACK_IMPORTED_MODULE_4__.applyPatches)(draft, patchesCopy);
                    // If the selected clip still exists after applying patches, keep it selected
                    const selectedClipsExist = prevSelectedClipIds.some((id) => draft.tracks.some((track) => track.clips.some((clip) => clip.id === id)));
                    if (!selectedClipsExist && draft.tracks.length > 0) {
                        // If no selected clips exist, try to select the first clip
        ...
        default: {
            const [nextState, patches, inversePatches] = (0,immer__WEBPACK_IMPORTED_MODULE_4__.produceWithPatches)(state, draft => {
                switch (action.type) {
                    ...
                    case _types_timeline__WEBPACK_IMPORTED_MODULE_1__.ActionTypes.ADD_TRACK:
                        ...
                        const newTrack = {
                            ...
                            allowOverlap: true,
                            transitionTypes: [_types_transition__WEBPACK_IMPORTED_MODULE_3__.TransitionType.Wipe, _types_transition__WEBPACK_IMPORTED_MODULE_3__.TransitionType.Dissolve, _types_transition__WEBPACK_IMPORTED_MODULE_3__.TransitionType.Fade],
                            transitionDefaults: {
                                duration: _utils_timelineConstants__WEBPACK_IMPORTED_MODULE_2__.TimelineConstants.Transitions.MIN_DURATION,
                                type: _types_transition__WEBPACK_IMPORTED_MODULE_3__.TransitionType.Wipe,
                                direction: 'right'
                            }
                        };
            ...
            if (isUndoable(action)) {
                ...
                const finalState = (0,immer__WEBPACK_IMPORTED_MODULE_4__.produce)(stateCopy, draft => {
                    ...
                    // Update history
                    // Create deep copies of patches to avoi
                });
                // Update history
                // Create deep copies of patches to avoi
            }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("354deae44fca0b465805")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=renderer.3d07009d8d25848db4db.hot-update.js.map